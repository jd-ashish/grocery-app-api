                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="{{ asset(setting("app_logo")) }}" alt="Logo"
                                                                        ...
                                                                        width="200" title="Logo" height="48">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://tutltt.stripocdn.email/content/guids/CABINET_54100624d621728c49155116bef5e07d/images/84141618400759579.png"
                                                                        alt
                                                                ...
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h2
                                                                        ...
                                                                        Order&nbsp;<a target="_blank" href=""
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:26px">#{{ $order->code }}</a>
                                                                    </h2>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0"><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#5c68e2;background:#5c68e2;border-width:2px;display:inline-block;border-radius:6px;width:auto"><a
                                                                            ...
                                                                            ORDER STATUS ON YOUR PHONE </a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center"
                                                                                    ...
                                                                                    <img class="adapt-img"
                                                                                        src="{{ get_image_by_upload_id($item->product->thumbnail_img) }}"
                                                                                        alt
                                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                                        width="70" height="70">
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Customer:
                                                                        <strong>@if($order->user->email==""){{ $order->user->phone }}@else{{ $order->user->email }}@endif</strong>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Order number:&nbsp;<strong>{{ $order->code }}</strong>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Invoice date:&nbsp;<strong>{{ $order->created_at }}</strong>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Payment method:&nbsp;<strong>{{ $order->payment_type }}</strong></p>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-txt-l"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Shipping Method: <strong>{{ ucwords(str_replace("_"," ",setting("shipping_method"))) }}</strong>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        Shipping address:</p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <strong>{{ $order->order_address->address }}</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Got a question?&nbsp;Email us at&nbsp;<a
                                                                            target="_blank" href="{{ setting("support_by_email") }}"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">{{ setting("support_by_email") }}</a>&nbsp;or
                                                                        give us a call at&nbsp;<a target="_blank"
                                                                            href="{{ setting("support_by_phone") }}"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">{{ setting("support_by_phone") }}</a>.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <img title="Facebook"
                                                                                    src="https://tutltt.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                style="padding:0;Margin:0;padding-right:40px">
                                                                                <img title="Twitter"
                                                                                    src="https://tutltt.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                style="padding:0;Margin:0;padding-right:40px">
                                                                                <img title="Instagram"
                                                                                    src="https://tutltt.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                style="padding:0;Margin:0"><img
                                                                                    title="Youtube"
                                                                                    src="https://tutltt.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
