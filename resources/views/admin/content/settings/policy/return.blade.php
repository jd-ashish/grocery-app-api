        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    {{ inline_brd(['Dashboard', 'POLICY', 'Return']) }}
                    <div class="d-flex justify-content-between align-items-end flex-wrap">
                        <a href="{{ route('return_policy') }}" target="__blank">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input name="key" value="return_policy" type="hidden" />
                            <textarea class="PageContent" id="PageContent" name="val">{!! (setting("return_policy")) !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>
