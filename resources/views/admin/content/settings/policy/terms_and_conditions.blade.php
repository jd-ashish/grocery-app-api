        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    {{ inline_brd(['Dashboard', 'POLICY', 'Terms & Conditions']) }}
                    <div class="d-flex justify-content-between align-items-end flex-wrap">
                        <a href="{{ route('terms_and_conditions') }}" target="__blank">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input name="key" value="terms_and_conditions" type="hidden" />
                            <textarea class="PageContent" id="PageContent" name="val">{!! (setting("terms_and_conditions")) !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>
