        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    {{ inline_brd(['Dashboard', 'POLICY', 'PRIVACY POLICY']) }}
                    <div class="d-flex justify-content-between align-items-end flex-wrap">
                        <a href="{{ route('privacy_policy') }}" target="__blank">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input name="key" value="privacy_policy" type="hidden" />
                            <textarea class="PageContent" id="PageContent" name="val">{!! (setting("privacy_policy")) !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>
