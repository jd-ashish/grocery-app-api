        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    {{ inline_brd(['Dashboard', 'POLICY', 'Contact Us']) }}
                    <div class="d-flex justify-content-between align-items-end flex-wrap">
                        <a href="{{ route('contact_us') }}" target="__blank">
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input name="key" value="contact_us" type="hidden" />
                            <textarea class="PageContent" id="PageContent" name="val">{!! (setting("contact_us")) !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>
