	...
	<div>
				...
				<tr>
					<td>
						@if($generalsetting->logo != null)
							<img loading="lazy"  src="{{ get_image_by_upload_id($generalsetting->logo) }}" height="40" style="display:inline-block;">
						@else
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
			<table>
				...
				<tr><td class="gry-color small">{{ $order->order_address->address }}</td></tr>
