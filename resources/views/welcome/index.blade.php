...
<html lang="en" class="no-js">
    <head>
		...
		<!-- jquery.fancybox  -->
        <link rel="stylesheet" href="{{ asset('welcome/css/jquery.fancybox.css') }}">
		<!-- animate -->
        <link rel="stylesheet" href="{{ asset('welcome/css/animate.css') }}">
		<!-- Main Stylesheet -->
        <link rel="stylesheet" href="{{ asset('welcome/css/main.css') }}">
		<!-- media-queries -->
        <link rel="stylesheet" href="{{ asset('welcome/css/media-queries.css') }}">

		<!-- Modernizer Script for old Browsers -->
        <script src="{{ asset('welcome/js/modernizr-2.6.2.min.js') }}"></script>
    ...
    <body id="body">
		...
		<!-- preloader -->
		<div id="preloader">
			<img src="{{ asset('welcome/img/preloader.gif') }}" alt="Preloader">
		</div>
		<!-- end preloader -->
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#body">
						<h1 id="logo">
							<img src="@if(setting("favicon")==""){{ asset('welcome/img/logo.png') }}@else{{ asset('welcome/img/logo.svg') }}@endif" alt="Brandi">
						</h1>
					</a>
					<!-- /logo -->
                </div>
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul id="nav" class="nav navbar-nav">
                        ...
                        <li><a href="#features">Download APP</a></li>
		...
		<section id="slider">
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					...
					<!-- single slide -->
					<div class="item active" style="background-image: url({{ asset('welcome/img/banner.jpg') }});">
						<div class="carousel-caption">
							<h2 data-wow-duration="700ms" data-wow-delay="500ms" class="wow bounceInDown animated">Grocey<span> World</span>!</h2>
							<h3 data-wow-duration="1000ms" class="wow slideInLeft animated"><span class="color">Say</span> Hey where you home.</h3>
							<p data-wow-duration="1000ms" class="wow slideInRight animated">I am here!</p>
                            <a href="{{ route("admin.login") }}" class="btn btn-info mt-2">Get Start Login</a>
					...
					<!-- single slide -->
					<div class="item" style="background-image: url({{ asset('welcome/img/banner.jpg') }});">
						<div class="carousel-caption">
							<h2 data-wow-duration="500ms" data-wow-delay="500ms" class="wow bounceInDown animated">Home<span> Need</span>!</h2>
							<h3 data-wow-duration="500ms" class="wow slideInLeft animated"><span class="color">Grocery</span> Goods.</h3>
                            <a href="{{ route("admin.login") }}" class="btn btn-info mt-2">Get Start Login</a>
		...
		<section id="works" class="works clearfix">
			...
			<div class="project-wrapper">
				...
				<figure class="mix work-item branding">
					<img src="{{ asset('welcome/img/works/item-1.jpg') }}" alt="">
				...
				<figure class="mix work-item web">
					<img src="{{ asset('welcome/img/works/item-2.jpg') }}" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item logo-design">
					<img src="{{ asset('welcome/img/works/item-3.jpg') }}" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item photography">
					<img src="{{ asset('welcome/img/works/item-4.jpg') }}" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item branding">
					<img src="{{ asset('welcome/img/works/item-5.jpg') }}" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item web">
					<img src="{{ asset('welcome/img/works/item-6.jpg') }}" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item logo-design">
					<img src="{{ asset('welcome/img/works/item-7.jpg') }}" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item photography">
					<img src="{{ asset('welcome/img/works/item-8.jpg') }}" alt="">
					<figcaption class="overlay">
				...
				<div class="row">
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms">
						<div class="member-thumb">
							<img src="{{ asset('welcome/img/team/member-1.png') }}" alt="Team Member" class="img-responsive">
							<figcaption class="overlay">
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="300ms">
						<div class="member-thumb">
							<img src="{{ asset('welcome/img/team/member-2.png') }}" alt="Team Member" class="img-responsive">
							<figcaption class="overlay">
								<h5>voluptatem quia voluptas </h5>
								<p>sit aspernatur aut odit aut fugit,</p>
								<ul class="social-links text-center">
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="600ms">
						<div class="member-thumb">
							<img src="{{ asset('welcome/img/team/member-3.png') }}" alt="Team Member" class="img-responsive">
							<figcaption class="overlay">
								<h5>voluptatem quia voluptas </h5>
								<p>sit aspernatur aut odit aut fugit,</p>
								<ul class="social-links text-center">
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-duration="500ms">
						<div class="footer-single">
							<img src="{{ asset('welcome/img/footer-logo.png') }}" alt="">
				...
				<div class="row">
					<div class="col-md-12">
						<p class="copyright text-center">
							Copyright © {{ date("Y") }} <a href="{{ url('/') }}"> {{ env("APP_NAME") }}</a>. All rights reserved. Designed & developed by <a href="#">Ashish Kumar</a>
						</p>
					</div>
				</div>
			</div>
		...
		<!-- Single Page Nav -->
        <script src="{{ asset('welcome/js/jquery.singlePageNav.min.js') }}"></script>
		<!-- Twitter Bootstrap -->
        <script src="{{ asset('welcome/js/bootstrap.min.js') }}"></script>
		<!-- jquery.fancybox.pack -->
        <script src="{{ asset('welcome/js/jquery.fancybox.pack.js') }}"></script>
		<!-- jquery.mixitup.min -->
        <script src="{{ asset('welcome/js/jquery.mixitup.min.js') }}"></script>
		<!-- jquery.parallax -->
        <script src="{{ asset('welcome/js/jquery.parallax-1.1.3.js') }}"></script>
		<!-- jquery.countTo -->
        <script src="{{ asset('welcome/js/jquery-countTo.js') }}"></script>
		<!-- jquery.appear -->
        <script src="{{ asset('welcome/js/jquery.appear.js') }}"></script>
